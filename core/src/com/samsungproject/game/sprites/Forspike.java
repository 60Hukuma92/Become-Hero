...
public class Forspike extends Enemy{
    ...
    public Forspike(Hero hero, PlayScreen screen, float x, float y) {
        super(screen, x, y);
        frames = new Array<TextureRegion>();
        frames.add(new TextureRegion(screen.getAtlas().findRegion("forspike"), 0 * 16, 0, 16, 16));
        frames.add(new TextureRegion(screen.getAtlas().findRegion("forspike"), 1 * 16, 0, 16, 16));
